...
class __TwigTemplate_d5530f08f92035c1c2140947e6d8dfc3652feaaffcb54761e7420ceeb391842a extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 6
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["userForm"]) || array_key_exists("userForm", $context) ? $context["userForm"] : (function () { throw new RuntimeError('Variable "userForm" does not exist.', 6, $this->source); })()), 'form');
        echo "
...
{% endblock %}
", "user/register.html.twig", "C:\\Users\\stagiaire\\Desktop\\Projet-SF\\Boutique\\templates\\user\\register.html.twig");
    }
}
