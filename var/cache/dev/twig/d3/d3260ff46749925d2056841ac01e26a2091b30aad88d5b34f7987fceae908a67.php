...
class __TwigTemplate_f10e3e715bc66d517d834ac86d0309e1b402c67fa551dab549f3f78a6f57b41f extends Template
{
    private $source;
    private $macros = [];
    ...
    <form class=\"\" method=\"post\" action=\"";
        ...
        // line 7
        echo twig_escape_filter($this->env, (isset($context["lastUsername"]) || array_key_exists("lastUsername", $context) ? $context["lastUsername"] : (function () { throw new RuntimeError('Variable "lastUsername" does not exist.', 7, $this->source); })()), "html", null, true);
        echo "\" />
        </div>
        <div class=\"form-group\">
...
{% block content %}
    <h1>Connexion</h1>
    <form class=\"\" method=\"post\" action=\"{{ path('login_check') }}\">
        <div class=\"form-group\">
            <input type=\"text\" class=\"form-control\" name=\"_username\" placeholder=\"Pseudo\" value=\"{{ lastUsername }}\" />
        </div>
        <div class=\"form-group\">
            <input type=\"password\" class=\"form-control\" name=\"_password\" placeholder=\"Mot de passe\" />
        </div>
...
{% endblock %}
", "user/login.html.twig", "C:\\Users\\stagiaire\\Desktop\\Projet-SF\\Boutique\\templates\\user\\login.html.twig");
    }
}
